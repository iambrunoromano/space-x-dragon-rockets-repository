...
public class DragonRocketsRepositoryTest {
  ...
  public static void assignRocketToMissionTest_GoodRocket_GoodMission_Rocketsinplace()
    ...
    assertOrThrow(
        actualRocket.getRocketStatusEnum(), RocketStatusEnum.IN_SPACE, "Assign Rocket to Mission");
    assertOrThrow(
        actualMission.getRockets().get(0), anotherPreexhistentRocket, "Assign Rocket to Mission");
  ...
  public static void changeRocketStatusToTest() throws Exception {
    ...
    public static void changeRocketStatusToTest_InRepair() throws Exception {
        Rocket rocket =
                DragonRocketsRepository
                        .addNewRocket(); // In this case if the test for addNewRocket() fails, the current test
        // will not be executed
        ...
        // will not be executed
        mission =
                DragonRocketsRepository.changeMissionStatusTo(mission,  MissionStatusEnum.PENDING);
